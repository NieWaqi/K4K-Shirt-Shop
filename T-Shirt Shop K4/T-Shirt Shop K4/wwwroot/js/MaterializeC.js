...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function (a) {
    ...
    var b = {
        init: function (b) {
            var c = {onShow: null};
            return b = a.extend(c, b), this.each(function () {
                var c, d, e = a(this), f = (a(window).width(), e.find("li.tab a")), g = e.width(),
                    h = Math.max(g, e[0].scrollWidth) / f.length, i = 0, j = function (a) {
                ...
                b.draggable && (e.on("click", function () {
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        var e = (c.gesture.direction, c.gesture.center.x),
                            g = (c.gesture.center.y, c.gesture.velocityX, a("body")), i = a("#sidenav-overlay"),
                            j = g.innerWidth();
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        var f = a('<div id="sidenav-overlay"></div>'), i = c.gesture.velocityX, j = c.gesture.center.x,
    ...
    function c(c) {
        ++j;
        var d = f.scrollTop(), e = f.scrollLeft(), g = e + f.width(), i = d + f.height(),
        ...
        this.init = function () {
            ...
            e.$document.off("click.chips-focus", b.CHIPS).on("click.chips-focus", b.CHIPS, function (c) {
                ...
                if (!a(c.target).is("input, textarea")) {
                    var d, f = e.$document.find(b.CHIP + b.SELECTED_CHIP), g = f.closest(b.CHIPS),
        ...
        init: function (b) {
            ...
            return b = a.extend(c, b), this.each(function () {
                ...
                var o, p, q, r, s, t, u, v, w, x, z, A, B, C, D, E, F, G = a('<ul class="indicators"></ul>'),
                    H = a(this), I = H.attr("data-indicators") || b.indicators;
